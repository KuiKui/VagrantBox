...
apt-get -y install php7.2 php7.2-cli libapache2-mod-php7.2 php7.2-mysql php7.2-curl php7.2-json php7.2-gd php7.2-mcrypt php-msgpack php-memcached php7.2-intl php7.2-sqlite3 php7.2-gmp php-geoip php7.2-mbstring php7.2-xml php7.2-zip php7.2-bcmath php7.2-ldap php-redis php7.2-soap
