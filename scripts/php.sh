...
apt-get -y install php7.1 php7.1-cli libapache2-mod-php7.1 php7.1-mysql php7.1-curl php7.1-json php7.1-gd php7.1-mcrypt php-msgpack php-memcached php7.1-intl php7.1-sqlite3 php7.1-gmp php-geoip php7.1-mbstring php7.1-xml php7.1-zip php7.1-bcmath php7.1-ldap php-redis
